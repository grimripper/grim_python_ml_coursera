class BivariateView(object):
    ...
    def get_column(self, name, avoid=None, numeric=False):
        ...
        columns = self.__numeric_columns() if numeric else self.obj.column_names()
    ...
    def __numeric_columns(self):
        ...
        selected = [(col, dtype) for (col, dtype) in columnsAndTypes if col in self.obj.column_names()]
