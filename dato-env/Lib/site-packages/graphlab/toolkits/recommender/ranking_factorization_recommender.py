...
graphlab.recommender.ranking_factorization_recommender.create for additional documentation.
"""
...
def create(observation_data,
    ...
    **Using the implicit alternating least squares model**
    ...
    :class:`graphlab.recommender.factorization_recommender.RankingFactorizationRecommender`
    ...
    _mt._get_metric_tracker().track('toolkit.recsys.ranking_factorization_recommender.create')
