...
class ProductSentimentModel(_CustomModel):
    ...
    def get_most_positive(self, keywords=None, groupby=None, k=10):
        ...
        This will use a :ref:`SearchModel` to obtain relevant reviews using
        the BM25 score for the text snippet and the provided keyword phrases.
        See :func:`~graphlab._internal.search.create` for more details on that
        model.
    ...
    def __getattribute__(self, attr):
        ...
        if attr == 'list_fields':
            ...
            return _CustomModel.__getattribute__(self, attr)
