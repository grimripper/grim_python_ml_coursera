...
class SentimentAnalysisModel(_CustomModel):
    ...
    def predict_row(self, row):
        ...
        m = self._state['classifier']
        f = self._state['feature_extractor']
    ...
    def evaluate(self, data, target=None, **kwargs):
        ...
        if self._state['method'] != 'bow-logistic':
    ...
    def summary(self):
        ...
        """
        return self._state['classifier'].summary()
