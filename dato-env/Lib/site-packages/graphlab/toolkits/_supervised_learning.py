...
class SupervisedLearningModel(Model):
    ...
    def get_current_options(self):
        ...
        return _graphlab.toolkits._main.run('supervised_learning_get_current_options', opts)
    ...
    def evaluate(self, dataset, metric="auto", missing_value_action='auto', options={}, **kwargs):
        """
