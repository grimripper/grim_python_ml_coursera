...
class NearestNeighborClassifier(_CustomModel):
    """
    Nearest neighbor classifiers predict the class of any observation to be the
    most common class among the observation's closest neighbors.
    ...
    _PYTHON_NN_CLASSIFIER_MODEL_VERSION = 0
    ...
    def get_current_options(self):
        ...
        current NearestNeighborClassifier instance.

        Returns
        -------
        out : dict
            Dictionary of option and values used to train the current instance
            of the NearestNeighborClassifier.
    ...
    def predict(self, dataset, max_neighbors=10, radius=None,
        ...
        """
        Return the predicted class label for each observations in ``dataset``,
        based on the closest neighbors stored in the nearest neighbors
        classifier model.
