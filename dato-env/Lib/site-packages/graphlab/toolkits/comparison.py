...
def show_comparison(model_comp_sframe=None, models=None):
    ...
    .. warning::
        ...
        This currently only works on Classifier or Recommender type models.
    ...
    models : list[models]
        ...
        Currently, only Recommender and Classifer are supported.

    Example
    -------
    Generate a model comparison on a Recommender or Classifier model type:
